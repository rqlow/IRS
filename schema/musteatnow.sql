...
values
('konchok', 'lim', 'kc_lim','asahi_village', 'konchok.lim@gmail.com', 'irs2021')
...
update musteatnow.stock_out
set user_dt= date_add(CURRENT_TIMESTAMP, interval -1 day)
where stock_id=3
;
...
-- STOCK MASTER TABLE2021-04-28 09:13:58
...
alter view musteatnow.vw_what_will_runout as 
with stock_out as
(select
	userid
	,stock_id 
